...
var types = __webpack_require__("C7iv");

// CONCATENATED MODULE: ./redux/reducer/user/userReducer.js
...
/* harmony default export */ var userReducer = ((state = initialState, {
  type,
  payload
}) => {
  switch (type) {
    case types["j" /* SAVE_GLOBAL_STATE */]:
    case types["c" /* CHANGE_CONDITIONS */]:
    case types["g" /* GET_USER_INFO */]:
      return _objectSpread({}, state, {
        loading: true,
        error: false
      });

    case types["i" /* GET_USER_INFO_SUCCESS */]:
      return _objectSpread({}, state, {
        user: payload,
        loading: false,
        error: false
    ...
    case types["e" /* CHANGE_CONDITIONS_SUCCESS */]:
      return _objectSpread({}, state, {
    ...
    case types["l" /* SAVE_GLOBAL_STATE_SUCCESS */]:
      return _objectSpread({}, state, {
        user: payload,
        isChanged: false
      });

    case types["f" /* CHANGE_SHOP_NAME */]:
      return _objectSpread({}, state, {
        user: _objectSpread({}, state.user, {
          shop_name: payload
        }),
    ...
    case types["b" /* CHANGE_CLIENT_GLOBALID */]:
      return _objectSpread({}, state, {
        user: _objectSpread({}, state.user, {
    ...
    case types["k" /* SAVE_GLOBAL_STATE_FAILURE */]:
    case types["d" /* CHANGE_CONDITIONS_FAILURE */]:
    case types["h" /* GET_USER_INFO_FAILURE */]:
      return _objectSpread({}, state, {
        error: true,
        loading: false
      });
...
const store = Object(external_redux_["createStore"])(rootReducer, Object(external_redux_devtools_extension_["composeWithDevTools"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a)));
...
global.fetch = __webpack_require__("4vsW");
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return GET_USER_INFO; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return GET_USER_INFO_SUCCESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return GET_USER_INFO_FAILURE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return CHANGE_CONDITIONS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return CHANGE_CONDITIONS_SUCCESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return CHANGE_CONDITIONS_FAILURE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return SAVE_GLOBAL_STATE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return SAVE_GLOBAL_STATE_SUCCESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return SAVE_GLOBAL_STATE_FAILURE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return CHANGE_SHOP_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CHANGE_AMMOUNT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CHANGE_CLIENT_GLOBALID; });
